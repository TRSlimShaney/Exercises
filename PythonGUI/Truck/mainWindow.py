...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.truckControlsBox = QtWidgets.QGroupBox(self.centralwidget)
        self.truckControlsBox.setGeometry(QtCore.QRect(400, 220, 211, 151))
        self.truckControlsBox.setObjectName("truckControlsBox")
        self.fowardButton = QtWidgets.QPushButton(self.truckControlsBox)
        self.fowardButton.setGeometry(QtCore.QRect(60, 30, 87, 29))
        self.fowardButton.setObjectName("fowardButton")
        self.leftButton = QtWidgets.QPushButton(self.truckControlsBox)
        self.leftButton.setGeometry(QtCore.QRect(10, 70, 87, 29))
        self.leftButton.setObjectName("leftButton")
        self.rightButton = QtWidgets.QPushButton(self.truckControlsBox)
        self.rightButton.setGeometry(QtCore.QRect(110, 70, 87, 29))
        self.rightButton.setObjectName("rightButton")
        self.stopButton = QtWidgets.QPushButton(self.truckControlsBox)
        self.stopButton.setGeometry(QtCore.QRect(36, 110, 131, 29))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Semi Truck"))
        ...
        self.truckControlsBox.setTitle(_translate("MainWindow", "Truck Controls"))
        ...
        self.stopButton.setText(_translate("MainWindow", "Jack-Knife to Stop"))
